...
#define prefix_path "/sys/class/leds/accton_as7327_56x_led::"
...
{LED_ACT, LED_MODE_OFF,          ONLP_LED_MODE_OFF},
{LED_ACT, LED_MODE_GREEN,        ONLP_LED_MODE_GREEN},
{LED_ACT, LED_MODE_RED,          ONLP_LED_MODE_RED},
{LED_ACT, LED_MODE_GREEN_BLINK,  ONLP_LED_MODE_GREEN_BLINKING},
{LED_ID,  LED_MODE_OFF,          ONLP_LED_MODE_OFF},
{LED_ID,  LED_MODE_BLUE,         ONLP_LED_MODE_BLUE},
...
static onlp_led_info_t linfo[] =
{
    { }, /* Not used */
    {
        ...
        ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED | ONLP_LED_CAPS_GREEN_BLINKING,
    },
    {
        { ONLP_LED_ID_CREATE(LED_BMC), "Chassis LED 2 (BMC LED)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED |
        ONLP_LED_CAPS_ORANGE | ONLP_LED_CAPS_GREEN_BLINKING,
    },
    {
        { ONLP_LED_ID_CREATE(LED_ID), "Chassis LED 3 (ID LED)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_BLUE,
    },
    {
        { ONLP_LED_ID_CREATE(LED_ACT), "Chassis LED 4 (ACT LED)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED |
    ...
    {
        { ONLP_LED_ID_CREATE(LED_PSU1), "Chassis LED 6 (PSU1 LED)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_AUTO,
    },
    {
        { ONLP_LED_ID_CREATE(LED_PSU2), "Chassis LED 7 (PSU2 LED)", 0 },
        ONLP_LED_STATUS_PRESENT,
        ONLP_LED_CAPS_AUTO,
    },
};
